...
{
    // SLICEHOUGH 参数
    constexpr double SLICEHOUGH_CLUSTER_RADIUS_KM = 50.0;   // 聚类搜索直径（KM）
    constexpr double SLICEHOUGH_ANGLE_RESOLUTION_DEG = 3.0; // 霍夫角度分辨率（度）
    constexpr double SLICEHOUGH_DIST_RESOLUTION_KM = 1.0;   // 霍夫距离分辨率（公里）
    ...
    constexpr int SLICEHOUGH_HOUGH_PEAKS = 10;              // 霍夫变换检测峰值数
